...
export default function StaffFullProfileView({
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 max-w-7xl mx-auto animate-in fade-in duration-150 text-xs">
      ...
      <div className="bg-white text-slate-800 rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative z-10">
          <div className="flex items-center gap-5">
            ...
            >
              {currentStaff.avatarUrl ? (
                <img 
                  ...
                  className="w-20 h-20 rounded-2xl object-cover ring-4 ring-blue-500/20 shadow-md group-hover:scale-105 transition"
                />
              ) : (
                <div className="w-20 h-20 rounded-2xl bg-slate-100 border-2 border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-600 group-hover:bg-slate-200 transition">
                  <span className="text-xs font-black uppercase tracking-wider">+ Photo</span>
                </div>
              )}

              {/* Hover Badge */}
              <div className="absolute inset-0 rounded-2xl bg-slate-900/60 opacity-0 group-hover:opacity-100 transition flex flex-col items-center justify-center text-white backdrop-blur-2xs">
                <span className="text-[9px] font-black tracking-wide text-white">CHANGE</span>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2.5">
                ...
                {isPending ? (
                  <span className="text-[10px] font-extrabold px-2.5 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-300 flex items-center gap-1.5 animate-pulse">
              ...
              <div className="flex flex-wrap items-center gap-3 text-[11px] text-slate-500 mt-2">
                <span className="font-mono bg-slate-100 px-2 py-0.5 rounded text-slate-700 font-bold border border-slate-200">{currentStaff.employeeNumber}</span>
                <span>•</span>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <button
              onClick={() => setShowAvatarModal(true)}
              className="flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs border border-slate-200 transition cursor-pointer"
            >
            ...
            {activeSubTab === 'profile' && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-md shadow-blue-500/20 transition hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
              >
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-slate-200/80 pb-3">
        ...
        >
          ...
          <span className={`px-2 py-0.5 rounded-full text-[10px] font-black ${
            activeSubTab === 'documents' ? 'bg-white/20 text-white' : 'bg-orange-100 text-orange-800'
          }`}>
