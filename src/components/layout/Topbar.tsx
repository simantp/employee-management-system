...
export default function Topbar({
  ...
  return (
    <header className="bg-[#eceef8] border-b border-purple-100/60 px-4 sm:px-8 py-4 sticky top-0 z-40 flex items-center justify-between gap-4 select-none shrink-0">
      
      {/* 1. Left Welcome Title matching reference image */}
      <div className="flex items-center gap-4">
        <div>
          <h1 className="text-base sm:text-lg font-extrabold text-slate-800 tracking-tight flex items-center gap-2">
            <span>Welcome to HSCreations Smart Operations</span>
          </h1>
          <p className="text-[11px] text-purple-900/60 font-medium hidden sm:block">
            Enterprise Workforce &amp; Shift Management System
          </p>
        </div>
      </div>

      {/* 2. Middle / Right Context and Actions */}
